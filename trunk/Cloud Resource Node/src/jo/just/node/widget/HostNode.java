...
//    }
    ...
    protected Sheet createSheet() {
        ...
        try {
            ...
            Property  hostNo = new PropertySupport.Reflection(obj, Integer.class, "hostNo");
            hostNo.setName("Host Number");
            host.put(hostNo);
            ...
            DropDownList bwProvisioner = new DropDownList(obj, "bwProvisioner", "BW Provisioner", "", obj.getItems("bwProvisioner"));
            host.put(bwProvisioner);
            
            DropDownList ramProvisioner = new DropDownList(obj, "ramProvisioner", "RAM Provisioner", "", obj.getItems("ramProvisioner"));
            host.put(ramProvisioner);
            
            DropDownList vmSchedular = new DropDownList(obj, "vmSchedular", "VM Schedular", "", obj.getItems("vmSchedular"));
            host.put(vmSchedular);

            DropDownList peProvisioner = new DropDownList(obj, "peProvisioner", "CPU Provisioner", "", obj.getItems("peProvisioner"));
            host.put(peProvisioner);
