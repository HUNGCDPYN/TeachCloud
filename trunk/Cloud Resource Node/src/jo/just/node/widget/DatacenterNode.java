...
//        System.err.println("");
    ...
    protected Sheet createSheet() {
        ...
        Sheet.Set power = sheet.createPropertiesSet();
        ...
        try {
            ...
            DateTime time = new DateTime(obj, "time", "Time", "");
            resorce.put(time);
...
//            resorce.put(vmAllocationPolicy);
            ...
            DropDownList networkTopology = new DropDownList(obj, "networkTopology", "Network Topology", "", obj.getItems("networkTopology"));
            ...
            DropDownList vmAllocationPolicy = new DropDownList(obj, "vmAllocationPolicy", "VM Allocation Policy", "", obj.getItems("vmAllocationPolicy"));
            power.put(vmAllocationPolicy);
            
            DropDownList vmSelectionPolicy = new DropDownList(obj, "vmSelectionPolicy", "VM Selection Policy", "", obj.getItems("vmSelectionPolicy"));
            power.put(vmSelectionPolicy);
            
            Property threshold = new PropertySupport.Reflection(obj, Double.class, "threshold");
            costPerBandwidth.setName("Threshold");
            power.put(threshold);
            ...
            power.setValue("tabName", "Power");
            power.setPreferred(true);
            power.setShortDescription("Datacenter power consumptions methodology and characteristics");
